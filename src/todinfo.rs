...
impl LeapSecTable {
    pub fn new() -> LeapSecTable {
        LeapSecTable(vec![
            LeapSec {
                day:   NaiveDate::from_ymd(2017, 01, 01,),
                tod:   0x000D1E0D68173CC0,
                count: 27,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(2015, 07, 01,),
                tod:   0x000CF2D54B4FBA80,
                count: 26,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(2012, 07, 01,),
                tod:   0x000C9CC9A704D840,
                count: 25,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(2009, 01, 01,),
                tod:   0x000C3870CB9BB600,
                count: 24,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(2006, 01, 01,),
                tod:   0x000BE251097973C0,
                count: 23,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1999, 01, 01,),
                tod:   0x000B1962F9305180,
                count: 22,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1997, 07, 01,),
                tod:   0x000AEE3EFA402F40,
                count: 21,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1996, 01, 01,),
                tod:   0x000AC34336FECD00,
                count: 20,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1994, 07, 01,),
                tod:   0x000A981F380EAAC0,
                count: 19,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1993, 07, 01,),
                tod:   0x000A7B70ABEB8880,
                count: 18,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1992, 07, 01,),
                tod:   0x000A5EC21FC86640,
                count: 17,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1991, 01, 01,),
                tod:   0x000A33C65C870400,
                count: 16,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1990, 01, 01,),
                tod:   0x000A1717D063E1C0,
                count: 15,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1988, 01, 01,),
                tod:   0x0009DDA69A557F80,
                count: 14,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1985, 07, 01,),
                tod:   0x000995D40F517D40,
                count: 13,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1983, 07, 01,),
                tod:   0x00095C62D9431B00,
                count: 12,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1982, 07, 01,),
                tod:   0x00093FB44D1FF8C0,
                count: 11,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1981, 07, 01,),
                tod:   0x00092305C0FCD680,
                count: 10,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1980, 01, 01,),
                tod:   0x0008F809FDBB7440,
                count: 9,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1979, 01, 01,),
                tod:   0x0008DB5B71985200,
                count: 8,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1978, 01, 01,),
                tod:   0x0008BEACE5752FC0,
                count: 7,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1977, 01, 01,),
                tod:   0x0008A1FE59520D80,
                count: 6,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1976, 01, 01,),
                tod:   0x0008853BAF578B40,
                count: 5,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1975, 01, 01,),
                tod:   0x0008688D23346900,
                count: 4,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1974, 01, 01,),
                tod:   0x00084BDE971146C0,
                count: 3,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1973, 01, 01,),
                tod:   0x00082F300AEE2480,
                count: 2,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(1972, 07, 01,),
                tod:   0x000820BA9811E240,
                count: 1,
            },
            LeapSec {
                day:   NaiveDate::from_ymd(0000, 01, 01,),
                tod:   0x0000000000000000,
                count: 0,
            },
        ],)
    }
